...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* Desktop Main Header */}
      <div className="hidden md:block bg-gradient-to-r from-white to-[#0D47A1]/5 px-4 lg:px-6 shadow-lg relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 md:gap-6 lg:gap-10 text-[#0D47A1]">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs md:text-sm mt-1">0479-2562489, 2664989</span>
              </div>
            </Link>
      ...
      <nav className="hidden md:block bg-[#0D47A1] shadow-lg sticky top-0 z-40">
              ...
              <div className="space-y-1 flex flex-col">
                ...
                <div className="w-full">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-200 ${
                        activeMobileDropdown === "nonacademic" ? "rotate-180" : ""
                      }`}
                    />
                  </button>
                  <div
